...
User.create(username: "ashley", password: "Ashley1", email:"ashley@gmail.com", name:"ahley", photo:"https://images.unsplash.com/flagged/photo-1572286647376-34f81176c4a1?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=634&q=80" ,age: 25, dob: "07/09/1991", city_state:"Bronx, Ny", about_me: "I like long walks on the beach.", sex: "female", active: false)
